...
function loadStylesheet() {
    ...
    const savedSheet = localStorage.getItem('selectedStylesheet') || '/TaskManagerNR/static/styles/mainstyle.css';
...
function initiateToggle() {
    ...
    if (toggleButton) {
        toggleButton.addEventListener('click', () => {
            ...
            const newSheet = currentSheet === '/TaskManagerNR/static/styles/mainstyle.css' 
                ? '/TaskManagerNR/static/styles/secstyle.css' 
                : '/TaskManagerNR/static/styles/mainstyle.css';
